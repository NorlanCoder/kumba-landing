        ...
        <div className='w-full text-xs'>
          <header class="p-2 text-center">
            <div className="flex justify-end">
              <button onClick={closeModalPolicies} className="font-semibold bg-white text-terre border-2 border-terre hover:bg-terre hover:text-white rounded-full px-4 py-2">X</button>
            </div>
            <h1 class="md:text-3xl text-xl font-bold text-terre mb-2">Politique de confidentialité</h1>
          ...
          <main class="container mx-auto px-4 py-12  max-h-[80vh] overflow-y-auto">
            ...
            <section id="account-management" class="mb-8">
                <h2 class="md:text-2xl text-xl text-terre font-semibold mb-4">Gestion des Comptes</h2>
            ...
            <section id="listing-management" class="mb-8">
                <h2 class="md:text-2xl text-xl text-terre font-semibold mb-4">Gestion des Annonces</h2>
                <p class="mb-4 text-lg">
            ...
            <section id="communication-tools" class="mb-8">
                <h2 class="md:text-2xl text-xl text-terre font-semibold mb-4">Outils de Communication</h2>
                <p class="mb-4 text-lg">
            ...
            <section id="data-security" class="mb-8">
                <h2 class="md:text-2xl text-xl text-terre font-semibold mb-4">Sécurité des Données</h2>
                <p class="mb-4 text-lg">
            ...
            <section id="support" class="mb-8">
                <h2 class="md:text-2xl text-xl text-terre font-semibold mb-4">Support et Assistance</h2>
                <p class="mb-4 text-lg">
            ...
            <section id="conclusion" class="mb-8">
              <h2 class="md:text-2xl text-xl text-terre font-semibold mb-4">Conclusion</h2>
              <p class="mb-4 text-lg">
