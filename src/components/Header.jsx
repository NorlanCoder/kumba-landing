    ...
    <div className="header">
        ...
        <div className="w-full h-[650px] -mt-16 bg-white flex">
            <div className="flex justify-between px-10 mt-24">
                <div className="text-content w-[50%] mt-20 ml-24">
                    ...
                    <h1 className='text-xl font-normal text-[#23273a] tracking-normal mt-12 my-4 md:mr-52 mr-32'>Discover the freedom of getting around hassle-free with our TripShare app. 
                        Simplify your life and discover a new way to get around.
                    </h1>
                    <div className="buttons flex mx-5 mt-12 gap-x-4">
                    ...
                    <div className="stats flex items-center mt-20">
                ...
                <div className="img z-10 w-[45%] flex mr-[8%] px-8 justify-center items-center mt-0">
