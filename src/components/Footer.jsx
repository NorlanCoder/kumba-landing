...
function Footer() {
  return (
    <>
      <section className="max-w-md my-5 mx-auto bg-terre p-2 rounded-lg flex items-center justify-between">
        <div className="text-white">
          ...
          <p className="text-xs font-light text-gray-200">
            La maison de vos rêves est à portée de clic. Notre application
            immobilière vous permet de découvrir, de visiter et d'acheter la
            propriété idéale, sans avoir à vous déplacer. Réservez votre temps
        ...
        <div className="">
          <img
            src="https://openui.fly.dev/openui/200x400.svg"
      ...
      <footer className="bg-white text-white">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="flex flex-wrap justify-between items-center pb-5 px-3 md:px-0 m-auto pt-3 border-t text-gray-700 text-sm max-w-6xl">
            ...
            <div className="md:flex-auto gap-3 md:flex-row-reverse mt-2 flex flex-row justify-center w-full sm:w-1/3">
              <div className="flex items-center justify-center border-gray-700 border rounded-full p-2">
                <a href="#" target="_blank" rel="noopener noreferrer">
                  <FaFacebookF className="w-4 h-4 hover:scale-110 text-gray-700 transition-all" />
                </a>
              </div>

              <div className="flex items-center justify-center border-gray-700 border rounded-full p-2">
                <a href="#" target="_blank" rel="noopener noreferrer">
                  <RiTwitterXFill className="w-4 h-4 hover:scale-110 text-gray-700 transition-all" />
                </a>
              </div>

              <div className="flex items-center justify-center border-gray-700 border rounded-full p-2">
                <a href="#" target="_blank" rel="noopener noreferrer">
                  <FaInstagram className="w-4 h-4 hover:scale-110 text-gray-700 transition-all" />
                </a>
              </div>

              <div className="flex items-center justify-center border-gray-700 border rounded-full p-2">
                <a href="#" target="_blank" rel="noopener noreferrer">
                  <FaYoutube className="w-4 h-4 hover:scale-110 text-gray-700 transition-all" />
                </a>
              </div>
            </div>
