...
const AboutUs = () => {
    return (
        <section className="py-14 max-w-6xl mx-auto relative select-none">
            ...
            <section className="bg-white py-12 mx-2 px-4 md:px-8 lg:px-16 flex flex-col md:flex-row items-center justify-between">
                <div className="relative mb-8 md:mb-0 md:w-1/2 flex justify-center">
                    ...
                    <img src={Iphone15} alt="" className="z-10 relative w-36 md:w-52 h-auto"/>
                </div>

                <section className="hidden sm:block opacity-50  absolute right-10 -top-10 z-20 transform">
                    <img src={Forme4} className="w-[4rem]" alt="Bilan Image" title='Bilan Image' />
                </section>

                <div className="md:w-1/2">
                    <h3 className="text-2xl text-gray-600 font-semibold mb-6">Des multitudes de services à votre disposition</h3>
